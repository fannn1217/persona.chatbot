...
tf.flags.DEFINE_integer("max_context_len", 100, "Truncate contexts to this length")
tf.flags.DEFINE_integer("max_utterance_len", 50, "Truncate utterance to this length")
tf.flags.DEFINE_integer("max_persona_len", 50, "Truncate persona to this length")
